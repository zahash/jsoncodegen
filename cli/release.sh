...
if [ -z "$1" ]; then
    ...
    echo "  Windows (msvc): x86_64-pc-windows-msvc, aarch64-pc-windows-msvc, i686-pc-windows-msvc"
    echo "  Windows (gnu):  x86_64-pc-windows-gnu, aarch64-pc-windows-gnu, i686-pc-windows-gnu"
