      ...
      wasi_snapshot_preview1: {
        ...
        fd_read: (fd, iovsPtr, iovsLen, nreadPtr) => {
          ...
          for (let i = 0; i < iovsLen; i++) {
            ...
            const remainingInput = this.input.length - this.inputCursor;
            ...
            if (bytesToRead > 0) {
              ...
              const dst = new Uint8Array(this.memory.buffer, ptr, bytesToRead);
              dst.set(src);
 ...
 * ```
 */
export async function runPlugin(wasmUrl, inputJson) {
